module.exports = function (schema){
  ...
  return {
    addItem: function(req, res){
      ...
      CarrinhoProduto.find({ where: {ID_Prod: ID_Prod, CPF_Cli: CPF_Cli, Tamanho_Prod: Tamanho_Prod} }).then(function(carrinhoProdutoDb){
        if(carrinhoProdutoDb){
          CarrinhoProduto.update({Qtd_Prod: (Qtd_Prod + carrinhoProdutoDb.Qtd_Prod)} , { where: {ID_Prod: ID_Prod, CPF_Cli: CPF_Cli, Tamanho_Prod: Tamanho_Prod} }).then(function(carrinhoProdutoDb){
    ...
    get: function (req, res) {
      ...
      CarrinhoProduto.findAll({ where: { CPF_Cli: CPF_Cli }, include: [{model: Produto, include: [ProdutoTamanho]}] }).then(function(carrinhoProdutoDb){
    ...
    delItem: function (req, res){
      ...
      CarrinhoProduto.destroy({ where : {ID_Prod: ID_Prod, CPF_Cli: CPF_Cli, Tamanho_Prod: Tamanho_Prod}})
        .then(function(carrinhoProdutoDb){
    ...
    editItem: function (req, res){
      ...
      CarrinhoProduto.find({ where: {ID_Prod: ID_Prod, CPF_Cli: CPF_Cli, Tamanho_Prod: Tamanho_Prod} }).then(function(carrinhoProdutoDb){
        if(carrinhoProdutoDb){
          CarrinhoProduto.update({Qtd_Prod: Qtd_Prod} , { where: {id: carrinhoProdutoDb.id} }).then(function(carrinhoProdutoDb){
